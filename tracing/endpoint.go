...
func TraceServer(tracer opentracing.Tracer, operationName string) moss.Middleware {
...
// OpenTracing Span called `operationName`.
func TraceClient(tracer opentracing.Tracer, operationName string) moss.Middleware {
	return func(next moss.Endpoint) moss.Endpoint {
		return func(ctx context.Context, request interface{}) (interface{}, error) {
